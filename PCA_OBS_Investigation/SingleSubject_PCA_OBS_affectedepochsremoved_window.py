...
# PCA-OBS excluding the epochs affected by a fit window
...
if __name__ == '__main__':
    ...
    epoch_path = "/data/p_02569/Images/SingleSubject_PCA-OBS_Dataset1/AffectedEpochs/"
    image_path = "/data/p_02569/Images/SingleSubject_PCA-OBS_Dataset1_AffectedEpochsRemoved/"
    ...
    for cond_name in cond_names:  # Conditions (median, tibial)
        ...
        for subject in subjects:  # All subjects
            ...
            # Affected Epochs
            ##############################################################################
            with open(f'{epoch_path}{subject_id}_{cond_name}_affectedepochs.pkl', 'rb') as f:
