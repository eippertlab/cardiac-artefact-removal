...
if __name__ == '__main__':
    ...
    method_names = ['Prep', 'PCA', 'ICA', 'CCA-heart', 'DSS-heart']
    SSP = False
                ...
                for subject in subjects:  # All subjects
                    ...
                    if method == 'Prep':
                        ...
                        epochs = mne.Epochs(clean_raw, events, event_id=event_id_dict, tmin=iv_epoch[0], tmax=iv_epoch[1],
                                            baseline=tuple(iv_baseline))
                        epochs.save(fname=input_path_CCA + f'epochs_{cond_name}_{n}.fif', overwrite=True)
                        ...
                        epochs = mne.Epochs(clean_raw, events, event_id=event_id_dict, tmin=iv_epoch[0], tmax=iv_epoch[1],
                                            baseline=tuple(iv_baseline))
                        epochs.save(fname=input_path_DSS + f'epochs_{cond_name}_{n}.fif', overwrite=True)
